...
<?php include('functions/ListPersonel.func.php') ?>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">
                            <form method="post">
                                <button type="submit" name="truncate_personel" class="btn btn-danger btn-sm" onclick="return confirm('Etes-vous sûre de supprimer tous le personnel de JoSchool ?') " title="Attention !"> <i class="bi bi-trash"></i> Supprimer tous le personnel</button>
                            </form>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="deletUtil.php?id_util=<?= $personel->id_util ?>&id_grade=<?= $personel->id_grade ?>" class="btn btn-danger btn-sm" onclick="return confirm('Etes-vous sûre de supprimer ce personnel ?') " data-toggle="tooltip" title="Attention !"><i class="bi bi-trash"></i> </a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
